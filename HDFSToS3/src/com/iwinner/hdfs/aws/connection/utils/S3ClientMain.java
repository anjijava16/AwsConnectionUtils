package com.iwinner.hdfs.aws.connection.utils;
import java.io.File;
...
public class S3ClientMain {
	private final static Logger logger = LoggerFactory.getLogger(S3ClientMain.class);
...
//			System.out.println(c.length);
			S3ClientMain s3Client = new S3ClientMain();
			s3Client.init();
